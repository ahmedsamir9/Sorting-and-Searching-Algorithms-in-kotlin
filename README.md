# SortingAlgorithms-in-kotlin
- inspired by [Strategy pattern](https://en.wikipedia.org/wiki/Strategy_pattern) and Kotlin i start to implenment following algothrims
## Bubble sort 
